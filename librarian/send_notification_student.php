...
<?php 
    ...
    {
        mysqli_query($link, "INSERT INTO `messages` (`id`, `susername`, `dusername`, `title`, `msg`, `read1`) VALUES (NULL, '$_SESSION[librarian]', '$_POST[dusername]', '$_POST[title]', '$_POST[msg]', 'n');" );
        ?>
